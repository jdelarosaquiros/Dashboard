      ...
      <Portal>
        ...
        >
          <Content
            side="bottom"
            align="start"
            className="mt-2 max-h-[65vh] min-w-[340px] overflow-y-auto rounded-lg border border-blue-200 bg-white shadow-lg dark:border-pink-700 dark:bg-gray-700 dark:text-white lg:max-h-[75vh]"
          >
