...
const LoginForm: React.FC<TLoginFormProps> = ({ onSubmit, startupConfig, error, setError }) => {
  ...
  return (
    <>
      {showResendLink && (
        <div className="mt-2 rounded-md border border-pink-500 bg-pink-500/10 px-3 py-2 text-sm text-gray-600 dark:text-gray-20">
      ...
      >
        <div className="mb-2">
          <div className="relative">
            ...
            <label
              htmlFor="email"
              className="absolute start-1 top-2 z-10 origin-[0] -translate-y-4 scale-75 transform bg-white px-3 text-sm text-gray-500 duration-100 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-3 peer-focus:text-blue-600 dark:bg-gray-850 dark:text-gray-400 dark:peer-focus:text-pink-500 rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4"
            >
        ...
        {startupConfig.passwordResetEnabled && (
          <a href="/forgot-password" className="text-sm text-blue-500 dark:text-pink-500">
