  ...
  return (
    <>
      <h2 className="mb-4 flex gap-2 text-base font-semibold dark:text-gray-20">
        <Layers3 className="icon-lg text-pink-500" />
                    ...
                    return (
                      <Tag
                        ...
                        className={cn(
                          ...
                          tag === 'production' &&
                            'bg-pink-100 text-pink-500 dark:border-pink-500 dark:bg-transparent dark:text-pink-500',
                        )}
                        labelClassName="flex m-0 justify-center gap-1"
                        LabelNode={
                          tag === 'production' ? (
                            <div className="flex items-center ">
                              <span className="slow-pulse h-[0.4rem] w-[0.4rem] rounded-full bg-pink-400" />
                            </div>
                          ) : null
                        }
                      />
