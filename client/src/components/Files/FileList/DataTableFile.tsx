...
export default function DataTableFile<TData, TValue>({
  ...
  return (
    <>
      ...
      <div className="relative mt-3 max-h-[25rem] min-h-0 overflow-y-auto rounded-md border border-black/10 pb-4 dark:border-pink-600 sm:min-h-[28rem]">
      ...
      <div className="ml-4 mr-4 mt-4 flex h-auto items-center justify-end space-x-2 py-4 sm:ml-0 sm:mr-0 sm:h-0">
        ...
        <Button
          className="dark:border-pink-500 dark:hover:bg-pink-600"
          variant="outline"
          size="sm"
