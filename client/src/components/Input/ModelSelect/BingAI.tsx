...
export default function BingAI({
  ...
  const defaultClasses =
    'p-2 rounded-md min-w-[75px] font-normal bg-white/[.60] dark:bg-gray-700 text-white text-xs';
  ...
  return (
    <>
      <Menu
        ...
        className={cn(
          cardStyle,
          'z-50 flex h-[40px] w-36 flex-none items-center justify-center px-4 ring-0 hover:cursor-pointer hover:bg-gray-50 focus:ring-0 focus:ring-offset-0 data-[state=open]:bg-gray-50 dark:bg-gray-800 dark:hover:bg-pink-700 dark:data-[state=open]:bg-gray-600',
      ...
      <Tabs
        ...
        className={cn(
          cardStyle,
          'z-50 flex h-[40px] flex-none items-center justify-center px-0 hover:bg-gray-50 dark:hover:bg-pink-700',
        )}
