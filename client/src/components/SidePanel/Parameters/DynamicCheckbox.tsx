        ...
        <HoverCardTrigger className="grid w-full items-center">
          <div className="flex justify-start gap-4">
            ...
            <Checkbox
              ...
              className="mt-[2px] focus:ring-opacity-20 dark:border-pink-500 dark:bg-gray-700 dark:text-gray-50 dark:focus:ring-pink-600 dark:focus:ring-opacity-50 dark:focus:ring-offset-0"
            />
          </div>
        </HoverCardTrigger>
        {description && (
