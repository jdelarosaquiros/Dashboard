        ...
        <SelectTrigger
          ...
          className={cn(
            ...
            isCollapsed
              ...
              : '',
            'bg-white text-white hover:bg-gray-50 dark:bg-gray-850 dark:text-white',
          )}
        >
        ...
        <RadixSelect.Portal>
          ...
          >
            <RadixSelect.Viewport className="mb-5 h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)]">
              <div className="group sticky left-0 top-0 z-10 flex h-12 items-center gap-2 bg-white px-2 px-3 py-2 text-white duration-300 dark:bg-gray-700 dark:text-white">
                ...
                <Combobox
                  ...
                  className="flex-1 rounded-md border-none bg-transparent px-2.5 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-gray-700/10 dark:focus:ring-pink-200/10"
                  ...
                  <RadixSelect.Item key={value} value={`${value ?? ''}`} asChild>
                    <ComboboxItem
                      className={cn(
                        ...
                        'rounded-lg hover:bg-gray-100/50 hover:bg-gray-50 dark:text-white dark:hover:bg-pink-600',
                      )}
                    >
